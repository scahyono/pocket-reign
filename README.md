...
- **Factions:** Each match randomly pairs your faction with a rival; icons in the HUD show the matchup. You can always roll the **Rest vs Restlessness** sleep theme, which links to a calming session on [YouTube](https://youtu.be/m8p3Ba_VJAQ?si=oWwliXAKsEuhIrYN).
